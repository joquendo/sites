  ...
  init: function() {
    ...
    Contacts.$form.addEventListener("submit", function(event) {
      var entry = {
        ...
        phone_number: parseInt(this.phone_number.value)
      }
    ...
    // initialize the table-add event listener to table and 
    // listen to the click events of edit | remove buttons
    Contacts.$table.addEventListener("click", function(event) {
      ...
      if (/edit|remove/.test(op)) {
        ...
        } // end if edit elseif remove
        event.preventDefault();
      } // end if data-op (edit | remove)
    }, true); // end addEventListener to table for edit remove action buttons (event delegation)
  },
